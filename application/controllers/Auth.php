        ...
        if ($user) {
            ...
            if ($user) {
                ...
                if ($user['is_active'] == 1) {
                    ...
                    $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert"> Email Belum Active</div>');
                    redirect('auth');
                }
            }
        } else {
            // jika gagal/belum terdatar
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert"> Email Belum Mendaftar</div>');
            redirect('auth');
        }
    }
